...
! [An image of the moodboard](readmeImages/Assets/jsconfig.png)
...
! [An image of the code refer 1](readmeImages/Assets/PerlinNoise.png)
_Fig 2: Live sketch. perlin noise_

Link to refernce 1: https://genekogan.com/code/p5js-perlin-noise/


! [An image of the code refer 2](readmeImages/Assets/Random.png)
